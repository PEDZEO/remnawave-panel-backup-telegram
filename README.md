...
| **[Reshala toolbox](https://github.com/DonMatteoVPN/Reshala-Remnawave-Bedolaga)** | Отдельная страница для внешнего набора функций Reshala |
...
В меню есть отдельная страница для внешнего проекта **[Reshala-Remnawave-Bedolaga](https://github.com/DonMatteoVPN/Reshala-Remnawave-Bedolaga)**.

Мы используем Reshala как дополнительный toolbox: карта функций, установка/обновление внешнего меню и запуск Reshala доступны из нашего скрипта. Код Reshala не копируется в этот репозиторий, потому что это отдельный проект со своими файлами и настройками.
