...
BACKUP_ON_CALENDAR_PANEL="${BACKUP_ON_CALENDAR_PANEL:-}"
BACKUP_ON_CALENDAR_BEDOLAGA="${BACKUP_ON_CALENDAR_BEDOLAGA:-}"
BACKUP_SETUP_SCOPE="${BACKUP_SETUP_SCOPE:-global}"
...
Schedule:
  BACKUP_ON_CALENDAR_PANEL='*-*-* 03:40:00 UTC'     panel timer schedule
  BACKUP_ON_CALENDAR_BEDOLAGA='*-*-* 03:40:00 UTC'  bedolaga timer schedule
